...
namespace micro::core::lib::driver::video
{
	...
	enum class Bytes : uintptr_t {};
	enum class Units : uintptr_t {};
	...
	namespace views
	{
		...
		using BytesSpan = NumericSpan<Bytes, u32>;
		using UnitsSpan = NumericSpan<Units, u32>;
	...
	using CByteBuffer = CBufferView;
	using MByteBuffer = MBufferView;
	...
	struct Device
	{
		...
		HCBUFFER create_CBuffer(Usage u, Flags f, Bytes l, CByteBuffer i = {}) noexcept { return upcast(this)->create_CBuffer(u, f, l, i); }
		HIBUFFER create_IBuffer(Usage u, Flags f, Bytes l, CByteBuffer i = {}) noexcept { return upcast(this)->create_IBuffer(u, f, l, i); }
		HSBUFFER create_SBuffer(Usage u, Flags f, Bytes l, CByteBuffer i = {}) noexcept { return upcast(this)->create_SBuffer(u, f, l, i); }
		HTBUFFER create_TBuffer(Usage u, Flags f, Bytes l, CByteBuffer i = {}) noexcept { return upcast(this)->create_TBuffer(u, f, l, i); }
		HVBUFFER create_VBuffer(Usage u, Flags f, Bytes l, CByteBuffer i = {}) noexcept { return upcast(this)->create_VBuffer(u, f, l, i); }

		//! --------------------------------------------------------------------------- !//

		void update(HCBUFFER h, Bytes o, CByteBuffer d) noexcept { upcast(this)->update(h, o, d); }
		void update(HIBUFFER h, Bytes o, CByteBuffer d) noexcept { upcast(this)->update(h, o, d); }
		void update(HSBUFFER h, Bytes o, CByteBuffer d) noexcept { upcast(this)->update(h, o, d); }
		void update(HTBUFFER h, Bytes o, CByteBuffer d) noexcept { upcast(this)->update(h, o, d); }
		void update(HVBUFFER h, Bytes o, CByteBuffer d) noexcept { upcast(this)->update(h, o, d); }

		//! --------------------------------------------------------------------------- !//

		MBufferView map(HCBUFFER h, Flags f, Bytes o, Bytes l) noexcept { return upcast(this)->map(h, f, o, l); }
		MBufferView map(HIBUFFER h, Flags f, Bytes o, Bytes l) noexcept { return upcast(this)->map(h, f, o, l); }
		MBufferView map(HSBUFFER h, Flags f, Bytes o, Bytes l) noexcept { return upcast(this)->map(h, f, o, l); }
		MBufferView map(HTBUFFER h, Flags f, Bytes o, Bytes l) noexcept { return upcast(this)->map(h, f, o, l); }
		MBufferView map(HVBUFFER h, Flags f, Bytes o, Bytes l) noexcept { return upcast(this)->map(h, f, o, l); }
