...
namespace micro::core::lib::io
{
	...
	extern int get_handle(File::Unique const &) noexcept;
	extern int get_handle(File::Shared const &) noexcept;
	...
	inline auto mmap(File::Unique const &f, int p, size_t l, off_t o) noexcept { return static_cast<NixMmap::Memory>(::mmap(NULL, l, p, MAP_SHARED, get_handle(f), o)); }
	inline auto mmap(File::Shared const &f, int p, size_t l, off_t o) noexcept { return static_cast<NixMmap::Memory>(::mmap(NULL, l, p, MAP_SHARED, get_handle(f), o)); }
