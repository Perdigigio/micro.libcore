...
namespace micro::core::lib::io
{
	...
	public:
		...
		friend int get_handle(File::Unique const &) noexcept;
		friend int get_handle(File::Shared const &) noexcept;
	...
	int get_handle(File::Unique const &f) noexcept { return file(f)->m_handle; }
	int get_handle(File::Shared const &f) noexcept { return file(f)->m_handle; }
